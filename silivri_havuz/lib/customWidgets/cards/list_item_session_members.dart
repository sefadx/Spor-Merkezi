        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              CircleAvatar(
                backgroundColor: appState.themeData.colorScheme.background,
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      member.displayName,
                      style:
                          appState.themeData.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold, color: appState.themeData.primaryColorDark),
                    ),
                    const SizedBox(height: 4),
                    Text(
                      "Telefon No: ${member.phoneNumber}",
              ...
              Icon(Icons.arrow_forward_ios, size: 16, color: appState.themeData.colorScheme.surface),
            ],
          ),
        ),
      ),
